...
import 'package:ecomik/controller/enter_phone_number_screen_controller.dart';
...
class EnterPhoneNumberScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EnterPhoneNumberScreenController>(
        init: EnterPhoneNumberScreenController(),
