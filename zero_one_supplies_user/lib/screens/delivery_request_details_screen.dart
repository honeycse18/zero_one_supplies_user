...
import 'package:ecomik/controller/delivery_request_details_controller.dart';
...
class DeliveryRequestDetailsScreen extends StatelessWidget {
  const DeliveryRequestDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DeliveryRequestDetailsScreenController>(
        init: DeliveryRequestDetailsScreenController(),
              ...
              child: Scaffold(
                ...
                appBar: CoreWidgets.appBarWidget(
                    ...
                    titleWidget: Text(AppLanguageTranslation
                        .deliveryRequestDetailsTransKey.toCurrentLanguage)),
